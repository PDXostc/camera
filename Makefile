...
kill.feb1:
	ssh app@$(TIZEN_IP) "pkgcmd -k JLRPOCX009.Cameras"
...
ifndef OBS
	...
	ssh app@$(TIZEN_IP) "pkgcmd -i -t wgt -p /home/app/JLRPOCX009.Cameras.wgt -q"
endif
...
install: deploy
	...
	ssh app@$(TIZEN_IP) "export DBUS_SESSION_BUS_ADDRESS='unix:path=/run/user/5000/dbus/user_bus_socket' && xwalkctl -i /home/app/JLRPOCX009.Cameras.wgt"
else
install: 
	cp -r JLRPOCX009.Cameras.wgt ${DESTDIR}/opt/usr/apps/.preinstallWidgets/
endif
